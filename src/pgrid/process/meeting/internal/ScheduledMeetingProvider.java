 ...
 */
public class ScheduledMeetingProvider implements Provider<PeerMeetingProcess> {
    ...
    @Inject
    public ScheduledMeetingProvider(LocalPeerContext context, ExchangeProvider eProvider, RepairProvider rProvider) {
        context_ = context;
    ...
    public PeerMeetingProcess get() {
        return new ScheduledMeetingProcess(context_.getLocalRT(), exchangeProvider_.get(), repairProvider_.get());
    }
}