 ...
 */
public class MeetingProvider implements Provider<PeerMeetingProcess> {

    private final ExchangeProvider exchangeProvider_;
    private final RepairProvider repairProvider_;

    @Inject
    public MeetingProvider(ExchangeProvider eProvider, RepairProvider rProvider) {
    ...
    public PeerMeetingProcess get() {
        return new DefaultMeetingProcess(exchangeProvider_.get(), repairProvider_.get());
    }
}
