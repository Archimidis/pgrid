...
/**
 * pgrid/service/corba/fileTransfer/TransferHandlePackage/DataHelper.java .
...
abstract public class DataHelper {
    private static String _id = "IDL:pgrid/service/corba/fileTransfer/TransferHandle/Data:1.0";
    ...
    synchronized public static org.omg.CORBA.TypeCode type() {
        if (__typeCode == null) {
            ...
            __typeCode = org.omg.CORBA.ORB.init().create_alias_tc(pgrid.service.corba.fileTransfer.TransferHandlePackage.DataHelper.id(), "Data", __typeCode);
        }
        return __typeCode;
    }
